...
class GeneratorEvaluationConfig:
    ...
    metrics: List[str] = field(default_factory=lambda: [
        "relevance", "coherence", "factual_accuracy", "overall_quality"
    ])
...
class E2EEvaluationConfig:
    ...
    metrics: List[str] = field(default_factory=lambda: [
        ...
        "factual_accuracy", "hallucination", "overall_quality"
    ])
...
class EvaluationConfig:
    ...
    retriever: RetrieverEvaluationConfig = field(default_factory=RetrieverEvaluationConfig)
    generator: GeneratorEvaluationConfig = field(default_factory=GeneratorEvaluationConfig)
