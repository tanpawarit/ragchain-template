...
class SemanticSimilarityMetrics:
    ...
    def semantic_precision(
        ...
        for gen_sent in gen_sentences:
            ...
            max_sim = max(
                (self.cosine_similarity(gen_sent, ref_sent) for ref_sent in ref_sentences),
                default=0.0
            )
    ...
    def semantic_recall(
        ...
        for ref_sent in ref_sentences:
            ...
            max_sim = max(
                (self.cosine_similarity(ref_sent, gen_sent) for gen_sent in gen_sentences),
                default=0.0
            )
...
class HallucinationMetrics:
    ...
    def context_consistency(
        answer: str,
        context: str,
        similarity_metric: Optional[Any] = None
    ) -> float:
        """
